...
from game.entities.player import Player, SimpleStats, SimpleAttributes
from game.protocols import Stats, Attributes
...
class CharacterMock(Character):
    ...
    def __init__(self):
        ...
        self.attributes = SimpleAttributes(self, self.stats)
        self.hp = 100
        self.energy = 50
...
class TestCharacter:
    ...
    def test_take_heal_over_max(self):
    ...
    def test_spend_energy_fail(self):
...
class TestPlayer:
    ...
    def test_player_initialization(self, base_player_data):
    ...
    def test_get_base_stats(self, base_player_data):
    ...
    def test_calculate_attributes(self, base_player_data):
    ...
    def test_calculate_exp_for_next_level(self, base_player_data):
    ...
    def test_gain_experience(self, base_player_data):
    ...
    def test_gain_experience_level_up(self, base_player_data):
    ...
    def test_gain_experience_multiple_level_up(self, base_player_data):
    ...
    def test_player_level_up(self, base_player_data):
    ...
    def test_experience_property(self, base_player_data):
        """Тест свойства опыта."""
        player = Player(
            name="TestPlayer",
            role="warrior",
...
class TestSimpleAttributes:
    ...
    def test_simple_attributes_calculation(self, mock_stats):
...
class TestCharacterPlayerIntegration:
    ...
    def test_player_inherits_character_behavior(self, base_player_data):
    ...
    def test_player_damage_handling(self, base_player_data):
